...
\item
Some consonats involved in the formation of conjuncts have signed forms. eg:\begingroup \manjari{  ്‌ര, ്‌ല, ്‌യ, ്‌വ, ര് . ക+്‌ര -> ക്ര, ക+്‌ല ->ക്ല , ക+്‌യ -> ക്യ, ക്+്‌വ -> ക്വ,  ര്+ക->  ൎക}\endgroup
...
\paragraph{}
The Figure \ref{newtestament}, shows pages from The New Testament printed using the types designed by Benchamin Bailey, imprinted in 1829.\cite{babucherian} The script continued to evolve by separating some vowel sign types (\begingroup \manjari{   ി, ീ } \endgroup) from the consonant/conjunct grapheme. Still the richness of conjuncts and their signed forms were largely retained. It can be seen from Figure \ref{Sabdatharavali}. 
...
\textit{Education, Newspapers, Books, Handwriting, Wall graffiti}
\paragraph{}
...
\bibitem{babucherian} Babu Cheriyan, \textit{Bebjamin Bailiyum Malayala Sahithyavum} \begingroup \manjari{(ബെഞ്ചമിൻ ബെയിലിയും മലയാള സാഹിത്യവും}) \endgroup, Mahatma Gandhi University, Kottayam, 2008
\bibitem{gupthannair} S. Gupthan Nair, \textit{Gadyam Pinnitta Vazhikal}\begingroup \manjari{ (ഗദ്യം പിന്നിട്ട വഴികൾ)} \endgroup, DC Books, Kottayam
