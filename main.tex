...
\item
Some consonats at the end of conjuncts have signed forms. eg: \manjari{  ്‌ര, ്‌ല, ്‌യ . ക+്‌ര -> ക്ര, ക+്‌ല ->ക്ല , ക+്‌യ -> ക്യ }
...
\paragraph{}
The Figure \ref{newtestament}, shows pages from The New Testament printed using the types designed by Benchamin Bailey, imprinted in 1829. The script continued to evolve by separating some vowel sign types (\begingroup \manjari{   ി, ീ } \endgroup) from the consonant/conjunct grapheme . Still the richness of conjuncts and their signed forms were largely retained. It can be seen from Figure \ref{Sabdatharavali}. 
